...
-(void)initUI{
    ...
    btnSelectBGM.layer.borderColor = kRGB_Value(0x0ACCAC).CGColor;
    ...
    [btnSelectBGM setTitleColor:kRGB_Value(0x0ACCAC) forState:UIControlStateNormal];
    ...
    btnStopBGM.layer.borderColor = kRGB_Value(0x0ACCAC).CGColor;
    ...
    [btnStopBGM setTitleColor:kRGB_Value(0x0ACCAC) forState:UIControlStateNormal];
    ...
    labVolumeForBGM.textColor = kRGB_Value(0x0ACCAC);
    ...
    labVolumeForVoice.textColor = kRGB_Value(0x0ACCAC);
    ...
    labBGMProcess.textColor = kRGB_Value(0x0ACCAC);
    //    [_labVolumeForVoice sizeToFit];
