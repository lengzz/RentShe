...
- (void)initUI
{
    ...
    customBackButton.tintColor = kRGB_Value(0xffffff);
    ...
    _timeLabel.textColor = kRGB_Value(0x777777);
    ...
    toImageView.backgroundColor = kRGB_Value(0x0accac);
    ...
    _leftTimeLabel.textColor = kRGB_Value(0x777777);
    ...
    _rightTimeLabel.textColor = kRGB_Value(0x777777);
    ...
    _progressView.tintColor = kRGB_Value(0x0accac);
    ...
    _progressedLabel.textColor = kRGB_Value(0x777777);
    ...
    bottomView.backgroundColor = kRGB_Value(0x181818);
    ...
    newPasterBtn.layer.borderColor = kRGB_Value(0x777777).CGColor;
...
- (void)createBubbleSelectView
{
    ...
    [animateBtn setTitleColor:kRGB_Value(0x0accac) forState:UIControlStateNormal];
    ...
    [staticBtn setTitleColor:kRGB_Value(0x0accac) forState:UIControlStateNormal];
