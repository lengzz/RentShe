    ...
    if (self) {
        ...
        for (int i = 0 ; i < EFFCT_COUNT ; i ++){
            ...
            switch ((TXEffectType)btn.tag) {
                ...
                {
                    [btn setBackgroundColor:kRGB_Value(0xEC5F9B)];
                }
                    break;
                case TXEffectType_DARK_DRAEM:
                {
                    [btn setBackgroundColor:kRGB_Value(0xEC8435)];
                }
                    break;
                case TXEffectType_SOUL_OUT:
                {
                    [btn setBackgroundColor:kRGB_Value(0x1FBCB6)];
                }
                    break;
                case TXEffectType_SCREEN_SPLIT:
                {
                    [btn setBackgroundColor:kRGB_Value(0x449FF3)];
                }
                    break;
