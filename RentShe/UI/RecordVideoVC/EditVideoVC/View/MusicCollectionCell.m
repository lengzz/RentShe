...
- (id)initWithFrame:(CGRect)frame
{
    if (self = [super initWithFrame:frame]) {
        self.backgroundColor = kRGB_Value(0x181818);
        ...
        _songNameLabel.textColor = kRGB_Value(0x777777);
        ...
        _authorNameLabel.textColor = kRGB_Value(0x555555);
...
- (void)setSelected:(BOOL)selected
{
    ...
    if (!selected) {
        ...
        _songNameLabel.textColor = kRGB_Value(0x777777);
        _authorNameLabel.textColor = kRGB_Value(0x555555);
        self.layer.borderColor = kRGB_Value(0x181818).CGColor;
    } else {
        _iconView.image = [UIImage imageNamed:@"voice_pressed"];
        _songNameLabel.textColor = kRGB_Value(0x0accac);
        _authorNameLabel.textColor = kRGB_Value(0x0accac);
        self.layer.borderWidth = 1;
        self.layer.borderColor = kRGB_Value(0x0accac).CGColor;
    }
}
