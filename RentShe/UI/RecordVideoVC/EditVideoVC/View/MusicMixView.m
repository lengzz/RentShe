...
- (id)initWithFrame:(CGRect)frame
{
    if (self = [super initWithFrame:frame]) {
        ...
        _titleLabel.textColor = kRGB_Value(0x777777);
        ...
        _songName.text = @"歌曲名";
        _songName.textColor = kRGB_Value(0x777777);
        ...
        [_deleteBtn setTitleColor:kRGB_Value(0x0accac) forState:UIControlStateNormal];
        ...
        _cutTitleLabel.textColor = kRGB_Value(0xcccccc);
