...
- (id)initWithFrame:(CGRect)frame
{
    if (self = [super initWithFrame:frame]) {
        ...
        _borderView.layer.borderColor = kRGB_Value(0x0accac).CGColor;
        ...
        _inputTextView.textColor = kRGB_Value(0xFFFFFF);
        ...
        _inputConfirmBtn.backgroundColor = kRGB_Value(0x0accac);
