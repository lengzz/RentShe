...
- (UISlider *)beautySlider
{
    if(!_beautySlider){
        ...
        [_beautySlider setMinimumTrackTintColor:kRGB_Value(0x0ACCAC)];
...
- (UILabel *)beautyLabel
{
    if(!_beautyLabel){
        ...
        _beautyLabel.text = @"0";
        [_beautyLabel setTextColor:kRGB_Value(0x0ACCAC)];
    }
    return _beautyLabel;
}
...
- (UISlider *)filterSlider
{
    if(!_filterSlider){
        ...
        [_filterSlider setMinimumTrackTintColor:kRGB_Value(0x0ACCAC)];
...
- (UILabel *)filterLabel
{
    if(!_filterLabel){
        ...
        _filterLabel.text = @"0";
        [_filterLabel setTextColor:kRGB_Value(0x0ACCAC)];
    }
    return _filterLabel;
}
